...
console.log(chalk.hex('#FF3366')("┃╭╮╭╮┣━━┫┃╭━━╮") + chalk.hex('#FFCC00')(" ✦ HamxyzOfficial"));
console.log(chalk.hex('#FF3366')("┃┃┃┃┃┃┃━┫┃┃╭╮┃") + chalk.cyan("  Telegram:"));
console.log(chalk.hex('#FF3366')("┃┃┃┃┃┃┃━┫╰┫╰╯┃") + chalk.greenBright("   @IsRealHamxyz"));
console.log(chalk.hex('#FF3366')("╰╯╰╯╰┻━━┻━┻━━╯\n"));
